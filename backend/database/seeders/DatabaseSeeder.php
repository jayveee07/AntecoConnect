...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 5. Feeders
        Feeder::create(['feeder_code' => 'FDR-001', 'name' => 'Tagum North Feeder', 'substation' => 'Tagum Main Substation', 'voltage_level' => '13.8kV', 'capacity_mva' => 25.00, 'current_load_mva' => 18.50, 'status' => 'active']);
        Feeder::create(['feeder_code' => 'FDR-002', 'name' => 'Tagum South Feeder', 'substation' => 'Tagum Main Substation', 'voltage_level' => '13.8kV', 'capacity_mva' => 20.00, 'current_load_mva' => 14.20, 'status' => 'active']);

        // 6. Transformers
        Transformer::create(['transformer_number' => 'XFRM-001', 'type' => 'pole_mounted', 'capacity_kva' => 100, 'voltage_primary' => '13.8kV', 'voltage_secondary' => '240V', 'phase_type' => 'single', 'latitude' => 7.4478, 'longitude' => 125.8040, 'barangay' => 'Poblacion', 'city' => 'Tagum City', 'province' => 'Davao del Norte', 'feeder' => 'FDR-001', 'status' => 'active', 'consumers_served' => 45]);
        Transformer::create(['transformer_number' => 'XFRM-002', 'type' => 'pad_mounted', 'capacity_kva' => 250, 'voltage_primary' => '13.8kV', 'voltage_secondary' => '480V', 'phase_type' => 'three', 'latitude' => 7.4500, 'longitude' => 125.8100, 'barangay' => 'Buenavista', 'city' => 'Tagum City', 'province' => 'Davao del Norte', 'feeder' => 'FDR-002', 'status' => 'active', 'consumers_served' => 78]);
        ...
        // 8. Payment Gateways
        PaymentGateway::create(['code' => 'gcash', 'name' => 'GCash', 'type' => 'mobile_wallet', 'is_active' => true, 'fee_percentage' => 1.50, 'fee_fixed' => 5.00, 'config' => ['merchant_id' => 'ANTECO-GCASH'], 'sort_order' => 1]);
        PaymentGateway::create(['code' => 'bayad_center', 'name' => 'Bayad Center', 'type' => 'over_the_counter', 'is_active' => true, 'fee_percentage' => 0.00, 'fee_fixed' => 10.00, 'config' => ['partner_code' => 'ANTECO-BAYAD'], 'sort_order' => 2]);

        // 9. Consumer Accounts
        $acct1 = ConsumerAccount::create(['user_id' => $consumer1->id, 'account_number' => 'ANT-ACC-00001', 'meter_number' => 'MTR-00001', 'service_address' => '123 Rizal St, Poblacion, Tagum City', 'connection_type' => 'residential', 'phase_type' => 'single', 'status' => 'active', 'has_smart_meter' => true, 'meter_multiplier' => 1.00, 'feeder' => 'FDR-001']);
        $acct2 = ConsumerAccount::create(['user_id' => $consumer2->id, 'account_number' => 'ANT-ACC-00002', 'meter_number' => 'MTR-00002', 'service_address' => '456 Mabini Ave, Buenavista, Tagum City', 'connection_type' => 'residential', 'phase_type' => 'single', 'status' => 'active', 'has_smart_meter' => false, 'meter_multiplier' => 1.00, 'feeder' => 'FDR-002']);
        ...
        // 11. Outages
        $outage1 = Outage::create(['ticket_number' => 'OUT-2024-001', 'reported_by' => $consumer1->id, 'type' => 'power_interruption', 'barangay' => 'Poblacion', 'city' => 'Tagum City', 'province' => 'Davao del Norte', 'description' => 'No power in our area since 2pm', 'priority' => 'high', 'status' => 'resolved', 'cause' => 'Fallen tree on power line', 'affected_consumers' => 120, 'estimated_restoration' => now()->subHours(3), 'restored_at' => now()->subHours(2)]);
        $outage2 = Outage::create(['ticket_number' => 'OUT-2024-002', 'reported_by' => $consumer2->id, 'type' => 'voltage_fluctuation', 'barangay' => 'Buenavista', 'city' => 'Tagum City', 'province' => 'Davao del Norte', 'description' => 'Lights flickering for the past hour', 'priority' => 'medium', 'status' => 'in_progress', 'cause' => 'Under investigation', 'affected_consumers' => 45, 'estimated_restoration' => now()->addHours(2)]);
        ...
        $ticket2 = SupportTicket::create(['ticket_number' => 'TKT-2024-002', 'user_id' => $consumer2->id, 'category' => 'connection', 'subject' => 'Request for new connection', 'description' => 'I would like to apply for a new electrical connection for my new house.', 'priority' => 'low', 'status' => 'open']);
        ...
        Announcement::create(['title' => 'New Payment Partner', 'content' => 'We are pleased to announce our partnership with GCash for online payments.', 'type' => 'general', 'priority' => 'normal', 'is_push_notification' => true, 'is_active' => true, 'published_at' => now(), 'created_by' => $admin->id]);
        ...
        $sr2 = ServiceRequest::create(['request_number' => 'SR-2024-002', 'user_id' => $consumer2->id, 'consumer_account_id' => $acct2->id, 'type' => 'meter_testing', 'status' => 'pending', 'preferred_date' => now()->addDays(7)]);

        // 17. Bills
        $bill1 = Bill::create(['consumer_account_id' => $acct1->id, 'bill_number' => 'BILL-2024-06-001', 'billing_period' => 'June 2024', 'billing_date' => now()->subDays(10), 'due_date' => now()->addDays(5), 'previous_reading' => 1000, 'current_reading' => 1250, 'consumption_kwh' => 250, 'previous_reading_date' => now()->subMonths(1), 'current_reading_date' => now()->subDays(10), 'consumption_days' => 30, 'generation_charge' => 1125, 'transmission_charge' => 200, 'system_loss_charge' => 125, 'distribution_charge' => 300, 'subsidies_charge' => 75, 'vat' => 220, 'franchise_tax' => 36, 'total_amount_due' => 2081, 'amount_paid' => 2081, 'balance' => 0, 'status' => 'paid', 'payment_status' => 'paid', 'paid_at' => now()->subDays(5)]);
        $bill2 = Bill::create(['consumer_account_id' => $acct1->id, 'bill_number' => 'BILL-2024-07-001', 'billing_period' => 'July 2024', 'billing_date' => now()->subDays(5), 'due_date' => now()->addDays(20), 'previous_reading' => 1250, 'current_reading' => 1520, 'consumption_kwh' => 270, 'previous_reading_date' => now()->subDays(10), 'current_reading_date' => now()->subDays(5), 'consumption_days' => 31, 'generation_charge' => 1215, 'transmission_charge' => 216, 'system_loss_charge' => 135, 'distribution_charge' => 324, 'subsidies_charge' => 81, 'vat' => 238, 'franchise_tax' => 39, 'total_amount_due' => 2248, 'amount_paid' => 0, 'balance' => 2248, 'status' => 'unpaid', 'payment_status' => 'unpaid']);
        $bill3 = Bill::create(['consumer_account_id' => $acct2->id, 'bill_number' => 'BILL-2024-06-002', 'billing_period' => 'June 2024', 'billing_date' => now()->subDays(10), 'due_date' => now()->subDays(2), 'previous_reading' => 800, 'current_reading' => 1020, 'consumption_kwh' => 220, 'previous_reading_date' => now()->subMonths(1), 'current_reading_date' => now()->subDays(10), 'consumption_days' => 30, 'generation_charge' => 990, 'transmission_charge' => 176, 'system_loss_charge' => 110, 'distribution_charge' => 264, 'subsidies_charge' => 66, 'vat' => 193, 'franchise_tax' => 32, 'total_amount_due' => 1831, 'amount_paid' => 1831, 'balance' => 0, 'status' => 'paid', 'payment_status' => 'paid', 'paid_at' => now()->subDays(6)]);
        $bill4 = Bill::create(['consumer_account_id' => $acct2->id, 'bill_number' => 'BILL-2024-07-002', 'billing_period' => 'July 2024', 'billing_date' => now()->subDays(5), 'due_date' => now()->addDays(20), 'previous_reading' => 1020, 'current_reading' => 1300, 'consumption_kwh' => 280, 'previous_reading_date' => now()->subDays(10), 'current_reading_date' => now()->subDays(5), 'consumption_days' => 31, 'generation_charge' => 1260, 'transmission_charge' => 224, 'system_loss_charge' => 140, 'distribution_charge' => 336, 'subsidies_charge' => 84, 'vat' => 245, 'franchise_tax' => 40, 'total_amount_due' => 2329, 'amount_paid' => 0, 'balance' => 2329, 'status' => 'unpaid', 'payment_status' => 'unpaid']);

        // 18. Work Orders
        WorkOrder::create(['work_order_number' => 'WO-2024-001', 'type' => 'outage', 'priority' => 'high', 'status' => 'completed', 'assigned_to' => $tech->id, 'supervisor_id' => $admin->id, 'outage_id' => $outage1->id, 'address' => '123 Rizal St', 'barangay' => 'Poblacion', 'city' => 'Tagum City', 'province' => 'Davao del Norte', 'scheduled_start' => now()->subDays(2), 'scheduled_end' => now()->subDays(2)->addHours(4), 'started_at' => now()->subDays(2), 'completed_at' => now()->subDays(2)->addHours(3), 'description' => 'Clear fallen tree from power line', 'completion_notes' => 'Tree removed, power restored.']);
        WorkOrder::create(['work_order_number' => 'WO-2024-002', 'type' => 'service_request', 'priority' => 'medium', 'status' => 'in_progress', 'assigned_to' => $tech->id, 'supervisor_id' => $admin->id, 'service_request_id' => $sr1->id, 'address' => '456 Mabini Ave', 'barangay' => 'Buenavista', 'city' => 'Tagum City', 'province' => 'Davao del Norte', 'scheduled_start' => now()->addDays(3), 'scheduled_end' => now()->addDays(3)->addHours(2), 'description' => 'Reconnect service for customer']);

        // 19. Transactions
        Transaction::create(['consumer_account_id' => $acct1->id, 'bill_id' => $bill1->id, 'processed_by' => $consumer1->id, 'transaction_number' => 'TXN-2024-06-001', 'type' => 'payment', 'payment_method' => 'gcash', 'amount' => 2081, 'fee' => 31.22, 'net_amount' => 2049.78, 'reference_number' => 'GCASH-REF-001', 'status' => 'completed', 'confirmed_at' => now()->subDays(5)]);
        Transaction::create(['consumer_account_id' => $acct2->id, 'bill_id' => $bill3->id, 'processed_by' => $consumer2->id, 'transaction_number' => 'TXN-2024-06-002', 'type' => 'payment', 'payment_method' => 'bayad_center', 'amount' => 1831, 'fee' => 10, 'net_amount' => 1821, 'reference_number' => 'BAYAD-REF-001', 'status' => 'completed', 'confirmed_at' => now()->subDays(6)]);

        // 20. Bill Readings
        BillReading::create(['bill_id' => $bill1->id, 'meter_reader_id' => $tech->id, 'reading_value' => 1250, 'reading_type' => 'regular', 'source' => 'manual', 'status' => 'verified']);
        BillReading::create(['bill_id' => $bill2->id, 'meter_reader_id' => $tech->id, 'reading_value' => 1520, 'reading_type' => 'regular', 'source' => 'manual', 'status' => 'verified']);

        // 21. Consumption Data
        ConsumptionData::create(['consumer_account_id' => $acct1->id, 'period_type' => 'monthly', 'period_date' => now()->subMonth(), 'period_year' => now()->year, 'period_month' => now()->subMonth()->month, 'consumption_kwh' => 250, 'estimated_cost' => 2081, 'status' => 'final']);
        ConsumptionData::create(['consumer_account_id' => $acct1->id, 'period_type' => 'monthly', 'period_date' => now(), 'period_year' => now()->year, 'period_month' => now()->month, 'consumption_kwh' => 270, 'estimated_cost' => 2248, 'status' => 'final']);
        ConsumptionData::create(['consumer_account_id' => $acct2->id, 'period_type' => 'monthly', 'period_date' => now()->subMonth(), 'period_year' => now()->year, 'period_month' => now()->subMonth()->month, 'consumption_kwh' => 220, 'estimated_cost' => 1831, 'status' => 'final']);
        ConsumptionData::create(['consumer_account_id' => $acct2->id, 'period_type' => 'monthly', 'period_date' => now(), 'period_year' => now()->year, 'period_month' => now()->month, 'consumption_kwh' => 280, 'estimated_cost' => 2329, 'status' => 'final']);

        // 22. Ai Predictions
        AiPrediction::create(['consumer_account_id' => $acct1->id, 'prediction_type' => 'consumption', 'period' => '2024-08', 'predicted_value' => 265, 'confidence_score' => 0.85, 'factors' => ['season' => 'rainy', 'historical_avg' => 260], 'recommendations' => ['Consider energy-saving measures during peak hours'], 'prediction_date' => now(), 'valid_until' => now()->addMonth()]);
        AiPrediction::create(['consumer_account_id' => $acct2->id, 'prediction_type' => 'consumption', 'period' => '2024-08', 'predicted_value' => 275, 'confidence_score' => 0.82, 'factors' => ['season' => 'rainy', 'historical_avg' => 250], 'recommendations' => ['Check for appliance efficiency'], 'prediction_date' => now(), 'valid_until' => now()->addMonth()]);
        ...
        TicketMessage::create(['ticket_id' => $ticket1->id, 'user_id' => $admin->id, 'message' => 'We will review your bill and get back to you within 24 hours.', 'is_staff_reply' => true, 'is_read' => true]);
        ...
        // 24. Reports
        Report::create(['report_number' => 'RPT-2024-001', 'type' => 'billing_summary', 'format' => 'pdf', 'status' => 'completed', 'parameters' => ['period' => 'June 2024', 'generated_by' => $admin->id], 'generated_by' => $admin->id, 'generated_at' => now()]);
        Report::create(['report_number' => 'RPT-2024-002', 'type' => 'outage_report', 'format' => 'pdf', 'status' => 'completed', 'parameters' => ['period' => 'Q2 2024', 'generated_by' => $admin->id], 'generated_by' => $admin->id, 'generated_at' => now()]);
        ...
        Document::create(['document_number' => 'DOC-2024-002', 'documentable_type' => 'App\Models\ServiceRequest', 'documentable_id' => $sr1->id, 'type' => 'requirement', 'category' => 'contract', 'file_name' => 'signed_contract.pdf', 'file_path' => 'documents/signed_contract.pdf', 'mime_type' => 'application/pdf', 'file_size' => 204800, 'description' => 'Signed service contract']);
    }
}
