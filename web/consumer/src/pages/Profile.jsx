  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      <div className="card text-center">
        ...
        <p className="text-gray-500">ANT-2024-001</p>
      ...
      <div className="card space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ProfileField icon={User} label="First Name" value="Juan" />
          <ProfileField icon={User} label="Last Name" value="Dela Cruz" />
          <ProfileField icon={Mail} label="Email" value="juan.delacruz@email.com" />
          <ProfileField icon={Phone} label="Mobile Number" value="+63 912 345 6789" />
          <ProfileField icon={MapPin} label="Address" value="123 Rizal St." />
          <ProfileField icon={Building2} label="Barangay/City" value="San Roque, San Juan" />
        </div>
      </div>
      ...
      <button className="flex items-center justify-center gap-2 w-full p-4 rounded-xl text-red-500 hover:bg-red-50 dark:hover:bg-red-950 transition-all font-medium">
