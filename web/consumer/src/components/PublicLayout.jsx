...
export default function PublicLayout({ children, isDark, toggleTheme }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-3">
              <img src="/anteco.png" alt="ANTECO" className="h-9 dark:mix-blend-multiply" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <img src="/anteco.png" alt="ANTECO" className="h-10 mb-4 dark:mix-blend-multiply" />
